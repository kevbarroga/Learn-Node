...
exports.forgot = async (req, res) => {
    ...
    if(!user) {
        req.flash('error', 'No account with that email exists'); // or send a msg like 'A password reset has been mailed to you.' for security precautions
        return res.redirect('/login');
    }
    // set reset tokens and expiry on thier account
